...
import { NButton, NPageHeader, NSpace, NTabs, NTabPane, useMessage } from 'naive-ui'
...
// Mission validation
const { isComplete, isWaypointFieldIncomplete, isFieldIncomplete } = useMissionValidation(mission)
        ...
        <template #extra>
          <NSpace>
            ...
            <NButton
              ...
              type="primary"
              :disabled="!isComplete"
              @click="handleExportMDC(mission)"
              >Export JSON MDC</NButton
            >
          </NSpace>
        </template>
      </NPageHeader>
