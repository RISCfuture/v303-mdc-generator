...
const dataCategories: DataCategory[] = [
  ...
  },
  {
    ...
    files: [
      {
        name: 'dtc/v93-dcsdtc.json',
        path: 'dtc/v93-dcsdtc.json',
        description: 'Default F-16C DCS-DTC configuration for v93 FS',
        note: 'Should be exported from DCS-DTC, not edited directly',
      },
      {
        name: 'dtc/v93-jafdtc.json',
        path: 'dtc/v93-jafdtc.json',
        description: 'Default F-16C JAFDTC configuration for v93 FS',
        note: 'Should be exported from JAFDTC, not edited directly',
      },
      {
        name: 'dtc/v93-dcsme.json',
        path: 'dtc/v93-dcsme.json',
        description: 'Default F-16C DCS Mission Editor configuration for v93 FS',
        note: 'Should be exported from DCS Mission Editor, not edited directly',
      },
      {
        name: 'dtc/v303-jafdtc.json',
        path: 'dtc/v303-jafdtc.json',
        description: 'Default A-10C JAFDTC configuration for v303 FS',
        note: 'Should be exported from JAFDTC, not edited directly',
      },
      {
        name: 'dtc/v303-dcsdtc.json',
        path: 'dtc/v303-dcsdtc.json',
