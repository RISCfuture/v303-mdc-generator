...
export interface Waypoint {
  ...
  // WIP: MGRS coordinate conversion to be added later
}
...
export interface CCIPData {
  referencePointType?: 'VIP' | 'VRP' // determines which reference point to use
...
export interface Mission {
  ...
  gunAmmoType?: string // Gun ammunition type (e.g., "HEI", "API", "TP", "Combat Mix") - airframe-specific
  ...
  htsThreatTables?: string[] // HTS threat tables (e.g., ["CLASS 1", "CLASS 2"] for F-16)
