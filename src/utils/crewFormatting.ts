 ...
 */
export function formatSTN(stn: number): string {
  return stn.toString().padStart(5, '0')
}
 ...
 */
export function formatMode3(mode3: number): string {
  return mode3.toString(8).padStart(4, '0')
}
 ...
 */
export function formatLaserCode(laserCode: number): string {
