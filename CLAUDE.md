...
- Verify all changes pass the following checks: `yarn lint:eslint`, `yarn stylelint`, `yarn type-check`, and `yarn test:unit`. You can also run `yarn test:e2e` for major changes.