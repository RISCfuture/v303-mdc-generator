...
def visualize_f16_fits():
    ...
    ax1.plot(gw_smooth, np.polyval(coeffs_takeoff, gw_smooth), 'b-', linewidth=2, label='Quadratic fit')
    ...
    ax2.set_title('F-16C Refusal Speed (AB) - Polynomial Regression', fontsize=14, fontweight='bold')
